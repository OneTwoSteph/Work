...
static void sf_gateway_c1_my_demo3(SFc1_my_demo3InstanceStruct *chartInstance);
...
static void c1_eml_scalar_eg(SFc1_my_demo3InstanceStruct *chartInstance);
...
static void sf_gateway_c1_my_demo3(SFc1_my_demo3InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_Kp, 0U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_Ki, 1U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_Kd, 2U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_dt, 3U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_derivative, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 6U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_e, 7U, c1_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_e_theta, 8U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_prev_error, 9U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_prev_integral, 10U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_v, 11U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_error, 12U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_integral, 13U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c1_error = c1_b_x * c1_d_x;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 9);
  c1_integral = c1_prev_integral + c1_error * 0.033;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 10);
  c1_A = c1_error - c1_prev_error;
  c1_e_x = c1_A;
  c1_f_x = c1_e_x;
  c1_g_x = c1_f_x;
  c1_derivative = c1_g_x / 0.033;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 11);
  c1_v = (10.0 * c1_error + c1_integral) + 0.1 * c1_derivative;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -11);
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("rdivide"), "name", "name", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 23);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_div"), "name", "name", 23);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3697654949U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2846949425U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(823189556U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2898019312U);
}
...
mxArray *sf_c1_my_demo3_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("JLlA8lRDJX3rWElxVeLzBB");
...
mxArray *sf_c1_my_demo3_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_my_demo3_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_my_demo3InstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c1_my_demo3((SFc1_my_demo3InstanceStruct*) chartInstanceVar);
}
  ...
  *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_my_demo3();/* state var info */
...
static void mdlSetWorkWidths_c1_my_demo3(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2594488204U));
  ssSetChecksum1(S,(1411359831U));
  ssSetChecksum2(S,(1855453191U));
  ssSetChecksum3(S,(2606670301U));
...
static void mdlStart_c1_my_demo3(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_my_demo3InstanceStruct *)utMalloc(sizeof
