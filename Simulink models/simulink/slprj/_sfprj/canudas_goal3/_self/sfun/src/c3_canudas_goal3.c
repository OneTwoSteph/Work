...
static const char * c3_debug_family_names[13] = { "b", "b1", "b2", "nargin",
  "nargout", "z", "thetad", "r", "qe", "k1", "k2", "w", "v" };

/* Function Declarations */
static void initialize_c3_canudas_goal3(SFc3_canudas_goal3InstanceStruct
  *chartInstance);
static void initialize_params_c3_canudas_goal3(SFc3_canudas_goal3InstanceStruct *
  chartInstance);
static void enable_c3_canudas_goal3(SFc3_canudas_goal3InstanceStruct
  *chartInstance);
static void disable_c3_canudas_goal3(SFc3_canudas_goal3InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_canudas_goal3
  (SFc3_canudas_goal3InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_canudas_goal3
  (SFc3_canudas_goal3InstanceStruct *chartInstance);
static void set_sim_state_c3_canudas_goal3(SFc3_canudas_goal3InstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_canudas_goal3(SFc3_canudas_goal3InstanceStruct
  *chartInstance);
static void sf_c3_canudas_goal3(SFc3_canudas_goal3InstanceStruct *chartInstance);
static void initSimStructsc3_canudas_goal3(SFc3_canudas_goal3InstanceStruct
  *chartInstance);
...
static real_T c3_b_emlrt_marshallIn(SFc3_canudas_goal3InstanceStruct
...
static real_T c3_mpower(SFc3_canudas_goal3InstanceStruct *chartInstance, real_T
  c3_a);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_canudas_goal3InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_canudas_goal3InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_canudas_goal3, const char_T
  *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_canudas_goal3InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_canudas_goal3InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_canudas_goal3 = 0U;
}
  ...
  (SFc3_canudas_goal3InstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_canudas_goal3;
...
const mxArray *sf_c3_canudas_goal3_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_canudas_goal3), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_canudas_goal3);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_canudas_goal3_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1793831697U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1532249576U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(789680403U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3026010228U);
}

mxArray *sf_c3_canudas_goal3_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("cHtAt0NY3wx7tjiXXTi9MH");
...
static const mxArray *sf_get_sim_state_info_c3_canudas_goal3(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[10],T\"v\",},{M[1],M[11],T\"w\",},{M[8],M[0],T\"is_active_c3_canudas_goal3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_canudas_goal3_get_check_sum(&mxChecksum);
...
{
  return "RbX1DuA7MIIAxSBJWx4nIG";
}

static void sf_opaque_initialize_c3_canudas_goal3(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_canudas_goal3InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_canudas_goal3((SFc3_canudas_goal3InstanceStruct*)
    chartInstanceVar);
  initialize_c3_canudas_goal3((SFc3_canudas_goal3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_canudas_goal3(void *chartInstanceVar)
{
  enable_c3_canudas_goal3((SFc3_canudas_goal3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_canudas_goal3(void *chartInstanceVar)
{
  disable_c3_canudas_goal3((SFc3_canudas_goal3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_canudas_goal3(void *chartInstanceVar)
{
  sf_c3_canudas_goal3((SFc3_canudas_goal3InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_canudas_goal3(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_canudas_goal3
    ((SFc3_canudas_goal3InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_canudas_goal3();/* state var info */
...
extern void sf_internal_set_sim_state_c3_canudas_goal3(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_canudas_goal3((SFc3_canudas_goal3InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_canudas_goal3(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_canudas_goal3(S);
}

static void sf_opaque_set_sim_state_c3_canudas_goal3(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c3_canudas_goal3(S, st);
}
...
{
  initSimStructsc3_canudas_goal3((SFc3_canudas_goal3InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_canudas_goal3(SimStruct *S)
{
  int i;
...
static void mdlRTW_c3_canudas_goal3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_canudas_goal3(SimStruct *S)
{
  SFc3_canudas_goal3InstanceStruct *chartInstance;
  chartInstance = (SFc3_canudas_goal3InstanceStruct *)malloc(sizeof
    (SFc3_canudas_goal3InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_canudas_goal3InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_canudas_goal3;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_canudas_goal3;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_canudas_goal3;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_canudas_goal3;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_canudas_goal3;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_canudas_goal3;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_canudas_goal3;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_canudas_goal3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_canudas_goal3;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_canudas_goal3;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_canudas_goal3;
...
void c3_canudas_goal3_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_canudas_goal3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_canudas_goal3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_canudas_goal3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_canudas_goal3_method_dispatcher.\n"
