...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_my_demo_ref2_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_my_demo_ref2_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_my_demo_ref2_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "my_demo_ref2") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_my_demo_ref2_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_my_demo_ref2_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "my_demo_ref2") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_my_demo_ref2_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_my_demo_ref2_method_dispatcher(SimStruct *S, unsigned int
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"my_demo_ref2")) {
    return(sf_my_demo_ref2_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void my_demo_ref2_terminator(void);
...
extern void my_demo_ref2_initializer(void);
extern void my_demo_ref2_register_exported_symbols(SimStruct* S);
extern void my_demo_ref2_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  my_demo_ref2_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      my_demo_ref2_debug_initialize();
    }

    my_demo_ref2_initializer();
  }
