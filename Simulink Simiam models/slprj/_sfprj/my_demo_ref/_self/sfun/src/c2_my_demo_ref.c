...
static void initialize_c2_my_demo_ref(SFc2_my_demo_refInstanceStruct
  *chartInstance);
static void initialize_params_c2_my_demo_ref(SFc2_my_demo_refInstanceStruct
  *chartInstance);
static void enable_c2_my_demo_ref(SFc2_my_demo_refInstanceStruct *chartInstance);
static void disable_c2_my_demo_ref(SFc2_my_demo_refInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_my_demo_ref
  (SFc2_my_demo_refInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_my_demo_ref
  (SFc2_my_demo_refInstanceStruct *chartInstance);
static void set_sim_state_c2_my_demo_ref(SFc2_my_demo_refInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_my_demo_ref(SFc2_my_demo_refInstanceStruct
  *chartInstance);
static void sf_gateway_c2_my_demo_ref(SFc2_my_demo_refInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_my_demo_ref(SFc2_my_demo_refInstanceStruct
  *chartInstance);
static void initSimStructsc2_my_demo_ref(SFc2_my_demo_refInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_my_demo_refInstanceStruct *chartInstance,
  const mxArray *c2_v, const char_T *c2_identifier, real_T c2_y[2]);
static void c2_b_emlrt_marshallIn(SFc2_my_demo_refInstanceStruct *chartInstance,
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_my_demo_refInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_my_demo_refInstanceStruct *chartInstance,
...
static real_T c2_rdivide(SFc2_my_demo_refInstanceStruct *chartInstance, real_T
  c2_x, real_T c2_y);
static real_T c2_abs(SFc2_my_demo_refInstanceStruct *chartInstance, real_T c2_x);
static real_T c2_power(SFc2_my_demo_refInstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_my_demo_refInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_my_demo_refInstanceStruct *chartInstance);
static void c2_threshold(SFc2_my_demo_refInstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_my_demo_refInstanceStruct *chartInstance);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_my_demo_refInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_my_demo_refInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_my_demo_ref, const char_T
  *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_my_demo_refInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_my_demo_refInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_my_demo_ref = 0U;
}
  ...
  (SFc2_my_demo_refInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_my_demo_ref;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_my_demo_ref = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_my_demo_ref");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_my_demo_ref(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_my_demo_ref(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_my_demo_refMachineNumber_,
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_mat, 1U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_R, 2U, c2_d_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_u_max, 3U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_a, 4U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_k1, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_k2, 6U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_K, 7U, c2_d_sf_marshallOut,
    c2_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 9U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_e, 10U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_theta, 11U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_v, 12U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_k1 = c2_rdivide(chartInstance, 1.0, c2_j_x) + c2_rdivide(chartInstance,
    10.0 * (1.0 - c2_l_x), c2_abs(chartInstance, c2_e[0]));
  ...
  c2_k2 = c2_rdivide(chartInstance, 1.0, c2_n_x) + c2_rdivide(chartInstance,
    10.0 * (1.0 - c2_p_x), c2_abs(chartInstance, c2_e[1]));
  ...
  for (c2_i7 = 0; c2_i7 < 2; c2_i7++) {
    ...
    for (c2_i9 = 0; c2_i9 < 2; c2_i9++) {
      c2_y[c2_i8 + c2_i7] = 0.0;
      c2_i10 = 0;
      for (c2_i11 = 0; c2_i11 < 2; c2_i11++) {
        c2_y[c2_i8 + c2_i7] += c2_b_a[c2_i10 + c2_i7] * c2_b[c2_i11 + c2_i8];
        c2_i10 += 2;
      }
  ...
  for (c2_i13 = 0; c2_i13 < 2; c2_i13++) {
    ...
    for (c2_i15 = 0; c2_i15 < 2; c2_i15++) {
      c2_b_y[c2_i14 + c2_i13] = 0.0;
      c2_i16 = 0;
      for (c2_i17 = 0; c2_i17 < 2; c2_i17++) {
        c2_b_y[c2_i14 + c2_i13] += c2_y[c2_i16 + c2_i13] * c2_b[c2_i17 + c2_i14];
        c2_i16 += 2;
      }
  ...
  for (c2_i25 = 0; c2_i25 < 2; c2_i25++) {
    ...
    for (c2_i27 = 0; c2_i27 < 2; c2_i27++) {
      c2_v[c2_i25] += c2_b_y[c2_i26 + c2_i25] * c2_b_b[c2_i27];
      c2_i26 += 2;
    }
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_my_demo_refInstanceStruct *chartInstance;
  chartInstance = (SFc2_my_demo_refInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_my_demo_ref_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("exp"), "name", "name", 14);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_my_demo_ref), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_my_demo_ref);
  return c2_y;
}
...
void sf_c2_my_demo_ref_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3849921055U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1484361507U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2361365460U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(246685758U);
}

mxArray *sf_c2_my_demo_ref_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("uzf4LS2n0ZL1baj3ezmAYG");
...
mxArray *sf_c2_my_demo_ref_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_my_demo_ref_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_my_demo_ref(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v\",},{M[8],M[0],T\"is_active_c2_my_demo_ref\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_my_demo_ref_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_my_demo_refInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_my_demo_refMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _my_demo_refMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "11Si8dwjrWLQvYA362f9OF";
}

static void sf_opaque_initialize_c2_my_demo_ref(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_my_demo_refInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_my_demo_ref((SFc2_my_demo_refInstanceStruct*)
    chartInstanceVar);
  initialize_c2_my_demo_ref((SFc2_my_demo_refInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_my_demo_ref(void *chartInstanceVar)
{
  enable_c2_my_demo_ref((SFc2_my_demo_refInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_my_demo_ref(void *chartInstanceVar)
{
  disable_c2_my_demo_ref((SFc2_my_demo_refInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_my_demo_ref(void *chartInstanceVar)
{
  sf_gateway_c2_my_demo_ref((SFc2_my_demo_refInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_my_demo_ref(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_my_demo_ref
    ((SFc2_my_demo_refInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_my_demo_ref();/* state var info */
...
extern void sf_internal_set_sim_state_c2_my_demo_ref(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_my_demo_ref();/* state var info */
  ...
  set_sim_state_c2_my_demo_ref((SFc2_my_demo_refInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_my_demo_ref(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_my_demo_ref(S);
}

static void sf_opaque_set_sim_state_c2_my_demo_ref(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_my_demo_ref(S, st);
}

static void sf_opaque_terminate_c2_my_demo_ref(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_my_demo_refInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_my_demo_ref((SFc2_my_demo_refInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_my_demo_ref((SFc2_my_demo_refInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_my_demo_ref(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_my_demo_ref(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1978055620U));
  ssSetChecksum1(S,(1787627631U));
  ssSetChecksum2(S,(392138804U));
  ssSetChecksum3(S,(2940026505U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_my_demo_ref(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_my_demo_ref(SimStruct *S)
{
  SFc2_my_demo_refInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_my_demo_refInstanceStruct *)utMalloc(sizeof
    (SFc2_my_demo_refInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_my_demo_refInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_my_demo_ref;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_my_demo_ref;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_my_demo_ref;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_my_demo_ref;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_my_demo_ref;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_my_demo_ref;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_my_demo_ref;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_my_demo_ref;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_my_demo_ref;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_my_demo_ref;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_my_demo_ref;
...
void c2_my_demo_ref_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_my_demo_ref(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_my_demo_ref(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_my_demo_ref(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_my_demo_ref_method_dispatcher.\n"
