  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3323185047U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2954548494U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(351170090U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2300590844U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(43305438U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4127628967U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2446358257U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3245054469U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "JLlA8lRDJX3rWElxVeLzBB") == 0) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "kp2kGS7rX2qawh6046KgDH") == 0) {
...
unsigned int sf_my_demo3_third_party_uses_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "KiRfA1Eow0EfRMOu3tvSbF") == 0) {
          extern mxArray *sf_c1_my_demo3_third_party_uses_info(void);
          plhs[0] = sf_c1_my_demo3_third_party_uses_info();
          break;
        }
      }
     ...
     case 2:
      {
        if (strcmp(tpChksum, "ATjyzAkDvBHyRpSS8NEzjB") == 0) {
          extern mxArray *sf_c2_my_demo3_third_party_uses_info(void);
          plhs[0] = sf_c2_my_demo3_third_party_uses_info();
          break;
        }
      }
...
unsigned int sf_my_demo3_updateBuildInfo_args_info( int nlhs, mxArray * plhs[],
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "KiRfA1Eow0EfRMOu3tvSbF") == 0) {
          extern mxArray *sf_c1_my_demo3_updateBuildInfo_args_info(void);
          plhs[0] = sf_c1_my_demo3_updateBuildInfo_args_info();
          break;
        }
      }
     ...
     case 2:
      {
        if (strcmp(tpChksum, "ATjyzAkDvBHyRpSS8NEzjB") == 0) {
          extern mxArray *sf_c2_my_demo3_updateBuildInfo_args_info(void);
          plhs[0] = sf_c2_my_demo3_updateBuildInfo_args_info();
          break;
        }
      }
...
void my_demo3_debug_initialize(struct SfDebugInstanceStruct* debugInstance)
{
  _my_demo3MachineNumber_ = sf_debug_initialize_machine(debugInstance,"my_demo3",
    "sfun",0,2,0,0,0);
  sf_debug_set_machine_event_thresholds(debugInstance,_my_demo3MachineNumber_,0,
    0);
  sf_debug_set_machine_data_thresholds(debugInstance,_my_demo3MachineNumber_,0);
}
