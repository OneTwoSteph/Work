...
static void sf_gateway_c2_my_demo(SFc2_my_demoInstanceStruct *chartInstance);
static void mdl_start_c2_my_demo(SFc2_my_demoInstanceStruct *chartInstance);
...
static void c2_emlrt_marshallIn(SFc2_my_demoInstanceStruct *chartInstance, const
  mxArray *c2_b_v, const char_T *c2_identifier, real_T c2_y[2]);
...
static void c2_threshold(SFc2_my_demoInstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_my_demoInstanceStruct *chartInstance);
...
static void init_simulink_io_address(SFc2_my_demoInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c2_i0 = 0; c2_i0 < 2; c2_i0++) {
    c2_u[c2_i0] = (*chartInstance->c2_v)[c2_i0];
  }
  ...
  const mxArray *c2_st)
{
  ...
  for (c2_i1 = 0; c2_i1 < 2; c2_i1++) {
    (*chartInstance->c2_v)[c2_i1] = c2_dv0[c2_i1];
  }
...
static void sf_gateway_c2_my_demo(SFc2_my_demoInstanceStruct *chartInstance)
{
  ...
  for (c2_i2 = 0; c2_i2 < 2; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_e)[c2_i2], 0U);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_my_demo(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_my_demoMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c2_i3 = 0; c2_i3 < 2; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_v)[c2_i3], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_theta, 2U);
}
...
static void c2_chartstep_c2_my_demo(SFc2_my_demoInstanceStruct *chartInstance)
{
  ...
  for (c2_i4 = 0; c2_i4 < 2; c2_i4++) {
    c2_b_e[c2_i4] = (*chartInstance->c2_e)[c2_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 9U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_b_e, 10U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_theta, 11U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_b_v, 12U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i21 = 0; c2_i21 < 2; c2_i21++) {
    c2_C[c2_i21] = c2_b_v[c2_i21];
  }

  for (c2_i22 = 0; c2_i22 < 2; c2_i22++) {
    c2_b_v[c2_i22] = c2_C[c2_i22];
  }

  c2_threshold(chartInstance);
  for (c2_i23 = 0; c2_i23 < 2; c2_i23++) {
    c2_C[c2_i23] = c2_b_v[c2_i23];
  }

  for (c2_i24 = 0; c2_i24 < 2; c2_i24++) {
    c2_b_v[c2_i24] = c2_C[c2_i24];
  }
  ...
  for (c2_i25 = 0; c2_i25 < 2; c2_i25++) {
    ...
    for (c2_i27 = 0; c2_i27 < 2; c2_i27++) {
      c2_b_v[c2_i25] += c2_b_y[c2_i26 + c2_i25] * c2_b_b[c2_i27];
      c2_i26 += 2;
    }
  }
  ...
  for (c2_i28 = 0; c2_i28 < 2; c2_i28++) {
    (*chartInstance->c2_v)[c2_i28] = c2_b_v[c2_i28];
  }
  ...
  mxArray *c2_b_v, const char_T *c2_identifier, real_T c2_y[2])
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_v), &c2_thisId, c2_y);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395332096U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m"),
                  "resolved", "resolved", 8);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286822322U), "fileTimeLo",
                  "fileTimeLo", 8);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 8);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395332104U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286822336U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395332100U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 17);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395332106U), "fileTimeLo",
                  "fileTimeLo", 17);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1375984290U), "fileTimeLo",
                  "fileTimeLo", 31);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 31);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1410811372U), "fileTimeLo",
                  "fileTimeLo", 32);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 32);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void init_simulink_io_address(SFc2_my_demoInstanceStruct *chartInstance)
{
  chartInstance->c2_e = (real_T (*)[2])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_v = (real_T (*)[2])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(686999218U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(689814499U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2660116648U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1260147758U);
}

mxArray* sf_c2_my_demo_get_post_codegen_info(void);
mxArray *sf_c2_my_demo_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("q9j0snENlDEX19ssEXOxwD");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_my_demo_get_post_codegen_info();
...
mxArray *sf_c2_my_demo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_my_demo_jit_fallback_info(void)
{
...
mxArray *sf_c2_my_demo_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_my_demoInstanceStruct *) chartInfo->chartInstance;
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_my_demoMachineNumber_,
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c2_e);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c2_v);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c2_theta);
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _my_demoMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  sf_gateway_c2_my_demo((SFc2_my_demoInstanceStruct*) chartInstanceVar);
}
...
static const mxArray* sf_opaque_get_sim_state_c2_my_demo(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_my_demo((SFc2_my_demoInstanceStruct*)
...
static void mdlProcessParameters_c2_my_demo(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_my_demo((SFc2_my_demoInstanceStruct*)
...
static void mdlSetWorkWidths_c2_my_demo(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3366333419U));
  ssSetChecksum1(S,(2965250041U));
  ssSetChecksum2(S,(947366787U));
  ssSetChecksum3(S,(348379040U));
...
static void mdlStart_c2_my_demo(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_my_demoInstanceStruct *)utMalloc(sizeof
