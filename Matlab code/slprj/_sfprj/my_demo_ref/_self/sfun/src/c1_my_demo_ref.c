...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(150604336U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4044603467U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(608546733U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4129075964U);
}
...
mxArray *sf_c1_my_demo_ref_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("HsyezlYQ081cNVjWam6HsH");
...
static void mdlSetWorkWidths_c1_my_demo_ref(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3342199773U));
  ssSetChecksum1(S,(4111640684U));
  ssSetChecksum2(S,(1238317996U));
  ssSetChecksum3(S,(3738381838U));
